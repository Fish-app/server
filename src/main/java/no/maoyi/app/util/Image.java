...
public class Image {
     ...
     * @throws IOException
     */
    private no.maoyi.app.resources.entity.Image savePhoto(FormDataMultiPart photos, File saveDir) throws IOException {
        ...
        if (images != null) {
            for (FormDataBodyPart part : images) {
                ...
                no.maoyi.app.resources.entity.Image photo = new no.maoyi.app.resources.entity.Image();
