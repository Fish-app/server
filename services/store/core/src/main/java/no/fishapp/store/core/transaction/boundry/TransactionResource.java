package no.fishapp.store.core.transaction.boundry;


import no.fishapp.app.auth.entity.Group;
import no.fishapp.app.rating.entity.Rating;
import no.fishapp.store.core.transaction.control.TransactionService;
import no.fishapp.app.transaction.transaction.DTO.StartTransactionData;
